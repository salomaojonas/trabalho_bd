Myapp::Application.routes.draw do
  ...
  resources :componente_matrizs
  resources :matricula_turmas
  resources :turmas
  ...
  root to: 'pages#login_2'
  get '/auth/:provider/callback' => 'sessions#create'
  get '/signin' => 'sessions#new', :as => :signin
  get '/signout' => 'sessions#destroy', :as => :signout
  get '/auth/failure' => 'sessions#failure'
	get '/callback' => "sessions#callback", :as => :callback
	get '/inicio' => 'horarios#incluir', :as => :inicio
	post '/importar_planilha' => 'disciplinas#incluir', :as => :importar_planilha
	get '/listar_discipinas' => 'componente_matrizs#index', :as => :listar_discipinas
