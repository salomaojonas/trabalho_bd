...
class AlunosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aluno" do
    assert_difference('Aluno.count') do
      post alunos_url, params: { aluno: { ano_ingresso: @aluno.ano_ingresso, curso_id: @aluno.curso_id, nome: @aluno.nome } }
    end
  ...
  test "should update aluno" do
    patch aluno_url(@aluno), params: { aluno: { ano_ingresso: @aluno.ano_ingresso, curso_id: @aluno.curso_id, nome: @aluno.nome } }
