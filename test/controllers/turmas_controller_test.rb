...
class TurmasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create turma" do
    assert_difference('Turma.count') do
      post turmas_url, params: { turma: { curriculo_id: @turma.curriculo_id, nome: @turma.nome } }
    end
  ...
  test "should update turma" do
    patch turma_url(@turma), params: { turma: { curriculo_id: @turma.curriculo_id, nome: @turma.nome } }
