...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post professors_url, params: { professor: { ano_ingresso: @professor.ano_ingresso, area_atuacao: @professor.area_atuacao, departamento_id: @professor.departamento_id, nome: @professor.nome } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { ano_ingresso: @professor.ano_ingresso, area_atuacao: @professor.area_atuacao, departamento_id: @professor.departamento_id, nome: @professor.nome } }
