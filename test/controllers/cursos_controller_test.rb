...
class CursosControllerTest < ActionController::TestCase
  ...
  test "should create curso" do
    assert_difference('Curso.count') do
      post :create, curso: { departamento_id: @curso.departamento_id, matriz_curricular_id: @curso.matriz_curricular_id, nome: @curso.nome }
    end
  ...
  test "should update curso" do
    patch :update, id: @curso, curso: { departamento_id: @curso.departamento_id, matriz_curricular_id: @curso.matriz_curricular_id, nome: @curso.nome }
    assert_redirected_to curso_path(assigns(:curso))
  end
